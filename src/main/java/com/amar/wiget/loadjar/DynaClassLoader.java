package com.amar.wiget.loadjar;
...
public class DynaClassLoader extends ClassLoader
{
	...
	public static void main( String [] args )
	{
		...
		try
		{
			url = new URL [] { new URL( "file:C:/test/JmxApp1.jar" ) };
			URLClassLoader loader = new URLClassLoader( url );

			DynaClassLoader dloader = new DynaClassLoader( loader );
			dloader.loadClass( "com.amar.JmxApp1" , false );
		}
